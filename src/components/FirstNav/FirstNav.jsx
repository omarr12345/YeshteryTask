        ...
        <div className="container h-100">
          <div className="row h-100 align-items-center">
            ...
            <div className="col-md-4 col-sm-4 col-4 d-flex justify-content-between">
              <button
                className="my-2 nav-btn-style position-relative"
                onClick={() => setShow(!show)}
              >
                <BsMinecartLoaded className="nav-icons mx-1" />
                <span className="cart-count fw-bold">{qua[0].quantity}</span>
        ...
        <div className="cart-content" ref={cartRef}>
          ...
          {qua[0].quantity == 0 ? (
            ...
            <div className="row container w-100">
              <div className="col-md-4 col-sm-4 col-4">Quantity</div>
              <div className="col-md-4 col-sm-4 col-4">Price</div>
              <div className="col-md-4 col-sm-4 col-4">Title</div>
              <hr></hr>
              <div className="col-md-4 col-sm-4 col-4">{qua[0].quantity}</div>
              <div className="col-md-4 col-sm-4 col-4">{qua[0].price}</div>
              <div className="col-md-4 col-sm-4 col-4">{qua[0].title}</div>
            </div>
          )}
        </div>
      ) : (
        <div className="cart-content d-none" ref={cartRef}>
          <div className="d-flex justify-content-between">
            <h3>Cart Items</h3>
